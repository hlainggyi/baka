...
<script>
import AcrademicStudentService from '@/api/AcrademicStudentService'
  export default {
    data: () => ({
      title_name: "Student List",
      search: '',
      grade: '5d024083f11b761d35d0fc05',
      desserts: [],
      pagination: {
        sortBy: 'name'
      },
    ...
    methods: {
      async getStudent () {
        this.desserts = (await AcrademicStudentService.index({grade: this.grade})).data.students
      },
      toggleAll () {
